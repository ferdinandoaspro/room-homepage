export default function ImageSelectors({handleIncr, handleDecr, position, display}: 
    ...
    const buttonStyle: string = "inline-grid place-items-center bg-black h-14 w-14 focus:bg-very-dark-gray md:w-[50%] md:h-[2.5rem] lg:h-[4rem] xl:h-[5rem] hover:bg-very-dark-gray"
